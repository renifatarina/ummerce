...
directory="static\image\product\tshirt"
searchImage="static\image\product\tshirt\1491497478.jpg"
index={}
def find(directory):
...
def top(histim,allimages):
    ...
    #   print ranked
      return ranked[0:5]
dir="static\image\product\tshirt"
sea="static\image\product\tshirt\1491497478.jpg"
